...
@SourceType(value = "AzureTablesARP", label = "AzureTables",uiConfig = "azuretables-layout.json")
public class AzureTablesConf extends AbstractArpConf<AzureTablesConf> {
  private static final String ARP_FILENAME = "arp/implementation/azuretables-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.azuretables.AzureTablesDriver";
